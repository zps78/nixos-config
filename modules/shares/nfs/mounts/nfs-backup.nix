# ../../modules/shares/nfs/mounts/nfs-backup.nix
#
...

{
  options.myShares.nfs-backup.enable =
    lib.mkEnableOption "NAS backup share";

  config = lib.mkIf config.myShares.nfs-backup.enable {
    # Import modules
  #  imports = [
  #    ../nfs-client.nix
  #  ];
